...
# Plots of Effect Sizes
  ...
  dat_rs %>% 
    ...
    ggplot(aes(x = control, y = manip, color = Percent_control)) + geom_point() + ylab("Manipulation") + xlab("Control") +
    theme_minimal() + facet_wrap(~depvar, scales = "free") + scale_color_gradient(low="purple", high="yellow")
